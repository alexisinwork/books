...
route=read(prod/'chapter-route.json')
for entry in route['chapters']:
 if entry['chapter']<=a.chapter:entry['status']='reviewed_draft_with_open_editorial_ledger'
update(prod/'chapter-route.json',route)
